...
#3 year과 수위 데이터 뿐만 아니라  삼림파괴정도-수위 관련 데이터가 있어야지만, 삼림파괴와 수위의 인과 관계를 알 수 있다. 삼림 파괴가 아니라 시간이 지나면서 변화된 또다른 요인에 의해 수위가 높아졌을지도 모르기 때문이다. 지금은 시간이 지날수록 최대수위가 높아지는 것 밖에 알지못한다. 
